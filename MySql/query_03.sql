...
-- In
select * from clg where place('Vandalur', 'potheri')

-- insert new column to table
alter table students add StuName varchar(200);

-- delete entire column in table 
alter table students drop colum StuName;

-- Inner join in table clg and student

select c.reg, c.clgname, s.dept from clg as clg
